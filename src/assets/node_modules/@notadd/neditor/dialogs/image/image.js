    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader.on('uploadBeforeSend', function (object, data, headers) {
              ...
              // data.fileName = object.file.name.split('.')[0];
              // data.modelName = object.file.name.split('.')[1];
              // data.type = '3';
                ...
                try {
                    if (editor.getOpt("imageUploadService")(_this, editor).getResponseSuccess(res)) {
                        ...
                        if (res.state && res.state === 'SUCCESS') {
                          if (localStorage.getItem('releaseEditImgInfo')) {
                            data = [...JSON.parse(localStorage.getItem('releaseEditImgInfo')), {id: res.id}]
                          } else {
                            data.push({id: res.id})
                          }
                          localStorage.setItem('releaseEditImgInfo', JSON.stringify(data));
                        }
